<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="proprietario.aspx.cs" Inherits="Pratical_Work2.proprietario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <a href="Propriedade__.aspx"><i class="fa fa-arrow-left"></i>Return</a>
    <h2>Lista de proprietarios</h2>

    <asp:GridView ID="GridView1" runat="server" OnRowDeleting="ownersItemDeleting" onrowupdating="ownersItemUpdating" CssClass="table table-hover" AutoGenerateColumns="False" AllowPaging="True" DataSourceID="XmlDataSource1" GridLines="None">
        <Columns>
        ...
        <EmptyDataTemplate>
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                Não há proprietarios nesta propriedade!
              </div>
            </div>
        </EmptyDataTemplate>
        <PagerStyle CssClass="pagination-ys" />
    </asp:GridView>
    <asp:Button ID="button1" runat="server" class="btn btn-primary btn-sm" OnClick="Button1_Click" Text="Adicionar Proprietário" />
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/App_Data/PropertiesData.xml" EnableCaching="False" XPath="/properties/property[land_register=9]/owners/owner"></asp:XmlDataSource>
</asp:Content>
